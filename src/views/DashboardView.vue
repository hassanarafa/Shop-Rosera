            ...
            <section v-if="activeTab === 'overview'" class="space-y-10">
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div class="bg-white/70 backdrop-blur-xl p-8 rounded-[2rem] border border-white/50 shadow-sm">
                        ...
                        <h3 class="text-3xl md:text-4xl font-serif text-stone-800">12,450 <span
                                class="text-lg text-rose-500 italic font-light">EGP</span></h3>
                    </div>
                    <div class="bg-white/70 backdrop-blur-xl p-8 rounded-[2rem] border border-white/50 shadow-sm">
                        <p class="text-[10px] uppercase tracking-widest text-stone-400 font-bold mb-2">Orders</p>
                        <h3 class="text-3xl md:text-4xl font-serif text-stone-800">48</h3>
                    </div>
                    <div class="bg-white/70 backdrop-blur-xl p-8 rounded-[2rem] border border-white/50 shadow-sm">
                        <p class="text-[10px] uppercase tracking-widest text-stone-400 font-bold mb-2">Avg. Basket</p>
                        <h3 class="text-3xl md:text-4xl font-serif text-stone-800">260 <span
                                class="text-lg text-rose-500 italic font-light">EGP</span></h3>
                    </div>
                </div>
            </section>
            ...
            <section v-if="activeTab === 'products'" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div v-for="i in 3" :key="i"
                        ...
                        <div
                            class="w-20 h-24 bg-rose-50/50 rounded-2xl overflow-hidden relative border border-rose-100/50">
                        </div>
                        <div class="flex-1 space-y-1">
                            <p class="font-serif text-xl text-stone-800 leading-tight">Rosera Splash</p>
                            <p class="text-xs text-stone-500 font-light italic">650 EGP</p>
                        </div>
                        <button
